...
`amount = amountWithoutTax + (tax_value + amountWithTax)` y con 2 decimales que son solicitados por el SRI.
* El `tax_value` hace referencia a el valor correspondiente con: `amountWithTax * tax`
